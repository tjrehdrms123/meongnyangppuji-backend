...
export declare class AnimalTypeController {
    ...
    createAnimalType(animalTypeData: CreateAnimalTypeDto): Promise<import("../entities/animal_type.entity").AnimalTypeEntity>;
    getAnimalTypeName(): Promise<import("../entities/animal_type.entity").AnimalTypeEntity[]>;
    getAnimalTypeByDetailName(name: string): Promise<string[]>;
    updateAnimalTypeByDetailName(animalTypeData: UpdateAnimalTypeByDetailNameDto): Promise<import("../entities/animal_type.entity").AnimalTypeEntity>;
