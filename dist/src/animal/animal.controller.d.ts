...
export declare class AnimalController {
    ...
    createAnimal(animalData: CreateAnimalDto): Promise<import("./animal.entity").AnimalEntity>;
    updateAnimal(animalData: UpdateAnimalDto): Promise<import("./animal.entity").AnimalEntity>;
