...
export class InitSchema1703558573380 implements MigrationInterface {
    name = 'InitSchema1703558573380'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`animal_type\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`name\` varchar(30) CHARACTER SET "utf8mb4" NOT NULL COMMENT '이름(강아지,고양이)', \`detail_name\` varchar(30) CHARACTER SET "utf8mb4" NOT NULL COMMENT '상세 이름 (푸들, 진돗개, 코리안 숏헤어...)', UNIQUE INDEX \`IDX_9cde3710dbe9aa5dbbe796bd29\` (\`detail_name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`qr\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`qr_issuance\` tinyint NOT NULL COMMENT 'QR 발행 여부 (0: 미발행, 1: 발행)', \`qr_use\` tinyint NOT NULL COMMENT 'QR 사용 여부 (0: 미사용, 1: 사용)', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`uploads\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`img\` varchar(255) NOT NULL COMMENT '원본 이미지', \`img_crop\` varchar(255) NULL COMMENT '크롭 이미지', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`card\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`background_color\` varchar(255) NOT NULL COMMENT '등록증 배경 색상', \`option\` int NOT NULL COMMENT '배경 레이아웃 (0: 기본, 1: 옵션1, 2: 옵션2...)', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`animal\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`name\` varchar(255) CHARACTER SET "utf8mb4" NOT NULL COMMENT '이름', \`introduction\` varchar(255) CHARACTER SET "utf8mb4" NOT NULL COMMENT '소개', \`age\` int NOT NULL COMMENT '나이', \`sex\` tinyint NOT NULL COMMENT '성별', \`uploads_id\` varchar(36) NULL, \`animal_type_id\` varchar(36) NULL, \`qr_id\` varchar(36) NULL, \`card_id\` varchar(36) NULL, UNIQUE INDEX \`REL_802786a5b9968d9ffedc81496a\` (\`uploads_id\`), UNIQUE INDEX \`REL_d0a8151b2b6d5b52f6024a18c9\` (\`qr_id\`), UNIQUE INDEX \`REL_00a33d0942f123abb5f5b790d8\` (\`card_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`user_id\` varchar(10) CHARACTER SET "utf8mb4" NOT NULL COMMENT '유저 아이디', \`password\` varchar(255) CHARACTER SET "utf8mb4" NOT NULL COMMENT '패스워드', \`role\` enum ('User', 'Admin') NOT NULL DEFAULT 'User', \`consent_check\` tinyint NOT NULL COMMENT '서비스이용약관', \`privacy_policy_check\` varchar(255) NOT NULL COMMENT '개인정보처리방침', UNIQUE INDEX \`IDX_96aac72f1574b88752e9fb0008\` (\`user_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`guardian\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`name\` varchar(10) CHARACTER SET "utf8mb4" NOT NULL COMMENT '보호자 이름', \`phone_number\` varchar(30) CHARACTER SET "utf8mb4" NOT NULL COMMENT '보호자 전화번호', \`users_id\` varchar(36) NULL, UNIQUE INDEX \`REL_cca83c2493b2821c7d650219a3\` (\`users_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`guardian_animal\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`guardian_id\` varchar(36) NULL, \`animal_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
