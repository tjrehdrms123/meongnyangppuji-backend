...
import { BaseInterfacAnimalTypeBaseeRepository } from './base.interface.animal_type.repository';

export abstract class BaseAbstractAnimalRepository<T extends AnimalTypeEntity> implements BaseInterfacAnimalTypeBaseeRepository<T> {
