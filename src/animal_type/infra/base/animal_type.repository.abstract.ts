...
export abstract class AnimalTypeRepositoryAbstract implements AnimalTypeRepositoryInterface<AnimalTypeEntity> {
  protected constructor(
    protected readonly AnimalTypeRepository: Repository<AnimalTypeEntity>
  ) {}
